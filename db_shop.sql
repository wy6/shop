...
CREATE TABLE `activate`  (
  `activateid` int(11) NOT NULL COMMENT '激活码id',
  `code` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '激活码',
  `expiredate` datetime DEFAULT NULL COMMENT '过期时间',
  `vipid` int(11) DEFAULT NULL COMMENT '所属会员',
...
CREATE TABLE `address`  (
  ...
  `addressname` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  ...
  `area` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `postcode` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `receiver` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  ...
  CONSTRAINT `address_ibfk_1` FOREIGN KEY (`vipid`) REFERENCES `user` (`vipid`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 17 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;

-- ----------------------------
-- Records of address
-- ----------------------------
INSERT INTO `address` VALUES (14, '龙湖镇', '河南省', '郑州市', '新郑市', '451191', 'veny', '13000000000', 1);
INSERT INTO `address` VALUES (15, '福田区富贵路', '河南省', '郑州市', '市辖区', '451191', 'fate', '13027720000', 1);
...
-- ----------------------------
INSERT INTO `bankaccount` VALUES (1, 'tank', 600);
INSERT INTO `bankaccount` VALUES (2, 'mank', 1000);
INSERT INTO `bankaccount` VALUES (3, 'fate', 1000);
INSERT INTO `bankaccount` VALUES (4, 'tom', 200);
INSERT INTO `bankaccount` VALUES (5, 'jack', 500);
INSERT INTO `bankaccount` VALUES (6, 'fate', 1000);
...
CREATE TABLE `category`  (
  ...
  `name` varchar(25) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '分类名称',
...
-- Records of category
-- ----------------------------
INSERT INTO `category` VALUES (1, '男装', 2);
INSERT INTO `category` VALUES (2, '女装', 2);
INSERT INTO `category` VALUES (3, '鞋靴', 3);
INSERT INTO `category` VALUES (4, '家电', 4);
INSERT INTO `category` VALUES (5, '家具', 5);
INSERT INTO `category` VALUES (6, '美食', 6);
INSERT INTO `category` VALUES (8, '数码', 7);
INSERT INTO `category` VALUES (12, '飞机', 8);
INSERT INTO `category` VALUES (13, '手机', 1);
...
CREATE TABLE `orderitem`  (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '订单条目编号',
  `buycount` int(11) DEFAULT NULL COMMENT '购买数量',
  `total` float DEFAULT NULL COMMENT '购买总价',
  `productid` int(11) DEFAULT NULL COMMENT '购买商品编号',
  ...
  `photo` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '商品封面路径',
  `orderid` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '所属订单编号',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `productid`(`productid`) USING BTREE,
  INDEX `orderid`(`orderid`) USING BTREE,
  CONSTRAINT `orderitem_ibfk_1` FOREIGN KEY (`productid`) REFERENCES `product` (`productid`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `orderitem_ibfk_2` FOREIGN KEY (`orderid`) REFERENCES `orders` (`orderid`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;

-- ----------------------------
-- Records of orderitem
-- ----------------------------
INSERT INTO `orderitem` VALUES (1, 1, 1194, 4, '哈吉斯（HAZZYS） 秋冬新款羊毛衫保暖圆领修身针织衫', 1194, 'uploadImages/2018/01/03/a8181fe442e540c6866fccb468c2e3471.111.jpg', 'bff9d53676d3447aa2c95567ffd9f2b7');
INSERT INTO `orderitem` VALUES (2, 1, 898, 6, '柳伊人品牌纯羊绒毛衣百搭套头打底衫女式高领上衣2604', 898, 'uploadImages/2018/01/03/779c1bd30e034dc48792cbf7dd4305ac3.4.jpg', '2db113a946a14ba68d3c8673382cd1c2');
INSERT INTO `orderitem` VALUES (3, 1, 898, 6, '柳伊人品牌纯羊绒毛衣百搭套头打底衫女式高领上衣2604', 898, 'uploadImages/2018/01/03/779c1bd30e034dc48792cbf7dd4305ac3.4.jpg', '8d530f9034d842d28682e7777f72e58d');
INSERT INTO `orderitem` VALUES (4, 1, 718, 13, 'olrain欧芮儿2017年冬装新款女装白鸭绒狐狸毛领羽绒服', 718, 'uploadImages/2018/01/03/799c893527bf47a5b4a063ac14e9416810.0.png', '8d530f9034d842d28682e7777f72e58d');
INSERT INTO `orderitem` VALUES (5, 1, 718, 13, 'olrain欧芮儿2017年冬装新款女装白鸭绒狐狸毛领羽绒服', 718, 'uploadImages/2018/01/03/799c893527bf47a5b4a063ac14e9416810.0.png', '9ad407726ce7483abb791f6bd5ed406f');
INSERT INTO `orderitem` VALUES (6, 2, 1796, 6, '柳伊人品牌纯羊绒毛衣百搭套头打底衫女式高领上衣2604', 898, 'uploadImages/2018/01/03/779c1bd30e034dc48792cbf7dd4305ac3.4.jpg', 'd600d6af024d4436acf50312b3bd5833');
...
CREATE TABLE `orders`  (
  ...
  `status` int(20) DEFAULT NULL COMMENT '订单状态',
  `addressname` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '收货详细地址',
  `postcode` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '邮编',
  `receiver` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '收货人',
  ...
  `content` varchar(400) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '订单备注',
  `vipid` int(11) DEFAULT NULL COMMENT '下单人id',
  PRIMARY KEY (`orderid`) USING BTREE,
  INDEX `vipid`(`vipid`) USING BTREE,
  CONSTRAINT `orders_ibfk_1` FOREIGN KEY (`vipid`) REFERENCES `user` (`vipid`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;

-- ----------------------------
-- Records of orders
-- ----------------------------
INSERT INTO `orders` VALUES ('2db113a946a14ba68d3c8673382cd1c2', '2018-01-08 00:00:00', 0, '河南省郑州市新郑市', '451191', 'veny', '13000000000', 898, '', 1);
INSERT INTO `orders` VALUES ('8d530f9034d842d28682e7777f72e58d', '2018-01-08 00:00:00', 0, '广东省广州市', '451191', 'fate', '13027720000', 1616, '', 1);
INSERT INTO `orders` VALUES ('9ad407726ce7483abb791f6bd5ed406f', '2018-01-08 16:54:07', 0, '广东省广州市', '451191', 'fate', '13027720000', 718, '', 1);
INSERT INTO `orders` VALUES ('bff9d53676d3447aa2c95567ffd9f2b7', '2018-01-07 00:00:00', 1, '河南省郑州市新郑市', '451191', 'veny', '13000000000', 1194, '', 1);
INSERT INTO `orders` VALUES ('d600d6af024d4436acf50312b3bd5833', '2018-01-08 23:21:39', 0, '广东省广州市', '451191', 'fate', '13027720000', 1796, '', 1);
...
CREATE TABLE `product`  (
  ...
  `markprice` float DEFAULT NULL COMMENT '市场价格',
  `quality` int(11) DEFAULT NULL COMMENT '库存量',
  `hit` int(11) DEFAULT NULL COMMENT '浏览量',
  `time` date DEFAULT NULL COMMENT '上架时间',
  `photo` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '商品图片',
  `introduction` text CHARACTER SET utf8 COLLATE utf8_general_ci COMMENT '商品简介',
  `content` text CHARACTER SET utf8 COLLATE utf8_general_ci COMMENT '商品描述',
  `categoryid` int(11) DEFAULT NULL COMMENT '商品分类',
...
-- Records of product
-- ----------------------------
INSERT INTO `product` VALUES (4, '哈吉斯（HAZZYS） 秋冬新款羊毛衫保暖圆领修身针织衫', 1194, 2040, 1000, 80, '2017-12-19', 'uploadImages/2018/01/03/a8181fe442e540c6866fccb468c2e3471.111.jpg', ' 由Hazzys旗舰店负责发货, 并提供售后服务. 今日16:00前下单,预计12月19日18:00前发货', '<p><img alt=\"\" src=\"/uploadImages/images/481e480116d3486dbe5a848edc42e91a1.jpg\" style=\"height:895px; width:790px\" /><img alt=\"\" src=\"/uploadImages/images/24ec58055cb2417c80f31401e4b0c6b91.0.jpg\" style=\"height:999px; width:790px\" /><img alt=\"\" src=\"/uploadImages/images/7fa4ed63a1c24d0c9e940d292dcc46201.1.jpg\" style=\"height:1394px; width:790px\" /><img alt=\"\" src=\"/uploadImages/images/f68079702dc74c34a8907c7ebe3795491.2.jpg\" style=\"height:1405px; width:790px\" /><img alt=\"\" src=\"/uploadImages/images/fe23bf43017e4c58932b6295cd5e415d1.jpg\" style=\"height:895px; width:790px\" /><img alt=\"\" src=\"/uploadImages/images/5a0752178e0a49babd3694f81dee1b3a1.0.jpg\" style=\"height:999px; width:790px\" /><img alt=\"\" src=\"/uploadImages/images/0221e69f26564da5aa13d7704ebcbc9b1.1.jpg\" style=\"height:1394px; width:790px\" /><img alt=\"\" src=\"/uploadImages/images/932652283ad5432c82fa9051f2c835781.2.jpg\" style=\"height:1405px; width:790px\" /></p>\r\n', 1);
INSERT INTO `product` VALUES (5, '小米6 全网通 4GB+64GB 亮黑色 4G手机 双卡双待', 2299, 2499, 665, 230, '2017-12-20', 'uploadImages/2017/12/20/33cdc42631374d84874a63eb96b9c7e75a011d6fNbc009d6e (1).jpg', '购机得米粉卡（内含100元话费）！小米6变焦双摄，拍人更美！5.15”屏幕，四曲面机身，骁龙835处理器！', '<p><img alt=\"\" src=\"/uploadImages/images/4ee5351ba0294975812e3d98648e17212.1.jpg\" style=\"height:629px; width:990px\" /><img alt=\"\" src=\"/uploadImages/images/f62bf48acae5479087173a58726d0aef2.2.jpg\" style=\"height:722px; width:990px\" /><img alt=\"\" src=\"/uploadImages/images/64b14c5c5e354e6d814b573a768715ac2.3.jpg\" style=\"height:1363px; width:990px\" /><img alt=\"\" src=\"/uploadImages/images/8f1a4c4fe8994aecb871494d1fde297e2.4.jpg\" style=\"height:1170px; width:990px\" /><img alt=\"\" src=\"/uploadImages/images/6709ff1bb2c241b8a5c4fd06a87d7a9b2.5.jpg\" style=\"height:573px; width:990px\" /></p>\r\n', 13);
INSERT INTO `product` VALUES (6, '柳伊人品牌纯羊绒毛衣百搭套头打底衫女式高领上衣2604', 898, 1366, 888, 153, '2017-12-20', 'uploadImages/2018/01/03/779c1bd30e034dc48792cbf7dd4305ac3.4.jpg', '柳伊人品牌羊绒衫女纯羊绒毛衣2017秋冬新款高翻领针织衫百搭套头打底衫女式高领上衣2604', '<p><img alt=\"\" src=\"/uploadImages/images/a95668912d764416a004ddd62c3ed2873.1.jpg\" style=\"height:941px; width:790px\" /><img alt=\"\" src=\"/uploadImages/images/e71ef4e5eaba4a4eaadd6c9e7888a4e83.2.jpg\" style=\"height:966px; width:790px\" /><img alt=\"\" src=\"/uploadImages/images/30b2a9abcdcd4b50a515ba72b8edde4f3.9.jpg\" style=\"height:1028px; width:790px\" /><img alt=\"\" src=\"/uploadImages/images/35693b8c459e413da832e94e56376b053.7.jpg\" style=\"height:1028px; width:790px\" /><img alt=\"\" src=\"/uploadImages/images/4aeb87c09b9f45698163218f4d07a24d3.5.jpg\" style=\"height:1022px; width:790px\" /><img alt=\"\" src=\"/uploadImages/images/aa2bd9f75fc74c4fb69738aa957a3e323.4.jpg\" style=\"height:960px; width:790px\" /><img alt=\"\" src=\"/uploadImages/images/080fdc7497074e328c79fcab0db731273.8.jpg\" style=\"height:1022px; width:790px\" /><img alt=\"\" src=\"/uploadImages/images/91f5c7b5fe494932bcc260761e7598183.6.jpg\" style=\"height:1028px; width:790px\" /><img alt=\"\" src=\"/uploadImages/images/342f41773e10489c853a4c688cd1443e3.3.jpg\" style=\"height:528px; width:790px\" /></p>\r\n', 2);
INSERT INTO `product` VALUES (7, '美菱(MELING)570升双开门变频无霜对开门冰箱', 4999, 5345, 233, 432, '2018-01-03', 'uploadImages/2018/01/03/e831f0d89ff146a8b0123072d5fece0f5.0.png', '爆款开抢! 下单立减600元 成交价仅4399元! 晒单再送价值千元礼品 大屏智能对开 远程控制 变频无霜。', '<p><img alt=\"\" src=\"/uploadImages/images/31d43f344a0340328c08f912cbe731745.1.jpg\" style=\"height:1138px; width:750px\" /><img alt=\"\" src=\"/uploadImages/images/a3e1b22a18454bbab58341066360b6d85.2.jpg\" style=\"height:697px; width:750px\" /><img alt=\"\" src=\"/uploadImages/images/8ff576a536f64725ac9af57cb61497075.3.jpg\" style=\"height:1647px; width:750px\" /><img alt=\"\" src=\"/uploadImages/images/0252eac1cde44139ad85449f084765fc5.5.jpg\" style=\"height:1659px; width:750px\" /></p>\r\n', 4);
INSERT INTO `product` VALUES (8, 'emugg雪地靴女公主粉短筒女靴保暖雪地棉 粉色 37', 399, 485, 2345, 322, '2018-01-03', 'uploadImages/2018/01/03/d32194eb3f184fd6ab96e0d4305e25754.0.png', '色彩斑斓的毛球总能为你带来缤纷的好心情，为了冬日增添一份色彩，俏皮可爱，满满少女感。', '<p><img alt=\"\" src=\"/uploadImages/images/9c31add3ac0d4f38b5b5fadb07284ca74.1.jpg\" style=\"height:588px; width:790px\" /><img alt=\"\" src=\"/uploadImages/images/58ff80bbca1b47a481da342f1944b78b4.4.jpg\" style=\"height:610px; width:790px\" /><img alt=\"\" src=\"/uploadImages/images/28ed8e9604bd4564994a8ae61fa785bb4.3.jpg\" style=\"height:570px; width:790px\" /><img alt=\"\" src=\"/uploadImages/images/4a3fe07f9b364d98b15b094c1e5af4144.2.jpg\" style=\"height:748px; width:790px\" /><img alt=\"\" src=\"/uploadImages/images/8e093a17a7f24890b68648759255e8cb4.5.jpg\" style=\"height:907px; width:790px\" /><img alt=\"\" src=\"/uploadImages/images/4298d0016c9e4199bb95b60020e669784.6.jpg\" style=\"height:492px; width:790px\" /></p>\r\n', 3);
INSERT INTO `product` VALUES (9, '索尼（SONY）ILCE-7K 全画幅微单相机标准套机', 7099, 7585, 531, 34, '2018-01-03', 'uploadImages/2018/01/03/bdd7e5bb2f4f4fb29df74b2fee7a89de6.0.png', '索尼（SONY）ILCE-7K 全画幅微单相机标准套机（约2430万有效像素 28-70mm镜头 1080P录像a7K/α7K）', '<p><img alt=\"\" src=\"/uploadImages/images/7fc878a9b4f6484f93901696961e51f46.1.jpg\" style=\"height:350px; width:750px\" /><img alt=\"\" src=\"/uploadImages/images/46516e2234a349c780cccc285de12c656.2.jpg\" style=\"height:450px; width:750px\" /><img alt=\"\" src=\"/uploadImages/images/cfc03472e9eb43d7b2897f7cda9f12016.3.jpg\" style=\"height:1376px; width:750px\" /><img alt=\"\" src=\"/uploadImages/images/117f94636c3e41229d4fa35ee09c5c916.4.jpg\" style=\"height:1166px; width:750px\" /><img alt=\"\" src=\"/uploadImages/images/fb0d9659250848eeb85cb6557ff148376.5.jpg\" style=\"height:2432px; width:750px\" /></p>\r\n', 8);
INSERT INTO `product` VALUES (10, '全友（QUANU） 欧式法式双人床1.8米板式婚床套装', 4499, 4890, 432, 235, '2018-01-03', 'uploadImages/2018/01/03/da468fa70a34474cb70d4cc5c9879f027.0.png', '全友（QUANU） 欧式法式双人床1.8米板式婚床卧室家具家居套装 121513 床+床头柜*2+105057床垫 1800*2000', '<p><img alt=\"\" src=\"/uploadImages/images/1b30299b237941eab9a4d685fc7cc8fb7.1.jpg\" style=\"height:819px; width:790px\" /><img alt=\"\" src=\"/uploadImages/images/a61726c0cdff4fcc860c5b489d8dc4087.2.jpg\" style=\"height:613px; width:790px\" /><img alt=\"\" src=\"/uploadImages/images/8dd9c02f94774ba4b1a80ce63686efad7.3.jpg\" style=\"height:449px; width:790px\" /><img alt=\"\" src=\"/uploadImages/images/95e0bbed01a946b5ad53d9853d382dd27.4.jpg\" style=\"height:844px; width:790px\" /><img alt=\"\" src=\"/uploadImages/images/0420e243aff742f199400f1c5e2ffecd7.5.jpg\" style=\"height:715px; width:790px\" /><img alt=\"\" src=\"/uploadImages/images/f233a812df394df3bae9026ebf0a9c937.6.jpg\" style=\"height:570px; width:790px\" /><img alt=\"\" src=\"/uploadImages/images/23290de7754c4a2ab53df0d86ca373137.7.jpg\" style=\"height:680px; width:790px\" /><img alt=\"\" src=\"/uploadImages/images/a454e6086db64594990ef29f1035a42b7.8.jpg\" style=\"height:441px; width:790px\" /></p>\r\n', 5);
INSERT INTO `product` VALUES (11, '全友（QUANU） 全友家居 茶几 现代简约客厅钢化玻璃茶几', 1899, 2350, 4322, 3452, '2018-01-03', 'uploadImages/2018/01/03/0d265db22c14441788988e6cca0cb7078.0.png', '全友（QUANU） 全友家居 茶几 现代简约客厅时尚家具钢化玻璃茶几 36111 茶几+电视柜（石材）', '<p><img alt=\"\" src=\"/uploadImages/images/c360ee38f8e0459d82db68ff41c3c2648.1.jpg\" style=\"height:517px; width:790px\" /><img alt=\"\" src=\"/uploadImages/images/df729e2cd48d4832ae3f46becae573858.2.jpg\" /><img alt=\"\" src=\"/uploadImages/images/f111e99d258c4c0ca6f93b73238c71c88.3.jpg\" /><img alt=\"\" src=\"/uploadImages/images/cc2e13f04f5948938ab2969f90e7ed848.4.jpg\" /><img alt=\"\" src=\"/uploadImages/images/cc2e13f04f5948938ab2969f90e7ed848.4.jpg\" style=\"height:543px; width:790px\" /><img alt=\"\" src=\"/uploadImages/images/a4a9184c60614ce89a96c90f8c57d1ee8.5.jpg\" /><img alt=\"\" src=\"/uploadImages/images/0a249db5b6c5482ebc3ecbb8d4a0b3c08.6.jpg\" /></p>\r\n', 5);
INSERT INTO `product` VALUES (12, ' 百草味 夏威夷果200gx3袋 坚果炒货零食干果每日坚果', 47.9, 58.5, 45676, 3423, '2018-01-03', 'uploadImages/2018/01/03/5a58fb583f6f44d8b28e74472268b79f9.0.png', ' 百草味 夏威夷果200gx3袋 坚果炒货零食干果每日坚果 奶油味 包装内含开果器', '<p><img alt=\"\" src=\"/uploadImages/images/b22358f930264addbbcf480b616025c09.1.jpg\" /><img alt=\"\" src=\"/uploadImages/images/b22358f930264addbbcf480b616025c09.1.jpg\" style=\"height:867px; width:990px\" /><img alt=\"\" src=\"/uploadImages/images/70acc34ff61a4607adf692588fa2414e9.2.jpg\" /><img alt=\"\" src=\"/uploadImages/images/0b4a34dfd7d242b290e2070ce9ece91c9.3.jpg\" /><img alt=\"\" src=\"/uploadImages/images/1d8b770946a14766a621044714cc4a929.4.jpg\" /><img alt=\"\" src=\"/uploadImages/images/bd14247602154a9cbec0e68f0ce166e49.5.jpg\" /><img alt=\"\" src=\"/uploadImages/images/111d8be50b2f4f528eedc43002b5f8a69.6.jpg\" /><img alt=\"\" src=\"/uploadImages/images/de396f879c614f7c86b926d820cf07fe9.7.jpg\" /></p>\r\n', 6);
INSERT INTO `product` VALUES (13, 'olrain欧芮儿2017年冬装新款女装白鸭绒狐狸毛领羽绒服', 718, 889, 1243, 2345, '2018-01-03', 'uploadImages/2018/01/03/799c893527bf47a5b4a063ac14e9416810.0.png', 'olrain欧芮儿2017年冬装新款女装白鸭绒狐狸毛领羽绒服女长款6213 黑色 M', '<p><img alt=\"\" src=\"/uploadImages/images/4004862f5eb840ce82a215d153b3908b10.1.jpg\" /><img alt=\"\" src=\"/uploadImages/images/8335a917288f449b89781f2338499cc810.2.jpg\" /><img alt=\"\" src=\"/uploadImages/images/93d5efb1d8b14fe596d75d9a0e7138be10.3.jpg\" /><img alt=\"\" src=\"/uploadImages/images/ca48ae9bd3a94d9d818f135f9eb8b6fa10.4.jpg\" /><img alt=\"\" src=\"/uploadImages/images/a3b35303a95a40e9b62a35f557f8e95110.6.jpg\" /></p>\r\n', 2);
INSERT INTO `product` VALUES (14, '复古英伦情侣真皮户外鞋马丁短靴', 299, 355, 355, 23, '2018-01-03', 'uploadImages/2018/01/03/b2873e04401c4c5894333e9abb3ce4c511.0.png', '头层牛皮男士工装鞋复古英伦情侣真皮户外鞋马丁短靴防滑中高帮夏 疯马棕（头层牛皮） 40', '<p><img alt=\"\" src=\"/uploadImages/images/8a462b7e34334331bf231b2314e24dc211.1.jpg\" /><img alt=\"\" src=\"/uploadImages/images/b15569b9208b4664b8a548a9dedc25c011.2.jpg\" /><img alt=\"\" src=\"/uploadImages/images/502a307b39c74b4ba9272e08d66be26811.3.jpg\" /><img alt=\"\" src=\"/uploadImages/images/1f29a75dca8f4248bed6b1bb11ba57cc11.4.jpg\" /></p>\r\n', 3);
INSERT INTO `product` VALUES (15, 'Beats Studio Wireless 头戴式耳机 - 红色', 2455, 2855, 124, 43, '2018-01-04', 'uploadImages/2018/01/04/1e55f2904adc46a4a627bdeb823761d812.0.png', 'Beats Studio Wireless 头戴式耳机 - 红色 录音师蓝牙无线版 HiFi 降噪 带麦 MH8K2CH/A', '<p><img alt=\"\" src=\"/uploadImages/images/1bec367fca1a428a94de39caf5ecfdd212.1.jpg\" /><img alt=\"\" src=\"/uploadImages/images/a052b56009564438838e74e9330baabc12.2.jpg\" /><img alt=\"\" src=\"/uploadImages/images/eb3fe6f52bb54661bbd89239f5787e5512.3.jpg\" /></p>\r\n', 8);
...
CREATE TABLE `user`  (
  `vipid` int(11) NOT NULL AUTO_INCREMENT COMMENT '用户ID，主键，自增',
  ...
  `photo` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '头像',
  `score` bigint(20) DEFAULT NULL COMMENT '等级',
  `question` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '密码提示问题',
  `answer` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '提示问题答案',
  `lastlogintime` datetime DEFAULT NULL COMMENT '最后一次登录时间',
  `status` int(1) DEFAULT 0 COMMENT '是否激活',
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (1, 'veny', 'root', NULL, 'veny@163.com', NULL, 0, NULL, NULL, '2017-12-21 23:24:09', 1);
INSERT INTO `user` VALUES (2, 'uuuluck', 'root', NULL, 'uuuluck@163.com', NULL, 0, NULL, NULL, '2017-12-21 23:38:12', 1);
INSERT INTO `user` VALUES (3, 'fate', 'root', NULL, 'fate@163.com', NULL, 0, NULL, NULL, '2017-12-21 23:40:29', 0);
INSERT INTO `user` VALUES (4, 'epan', 'root', NULL, 'epan@163.com', NULL, 0, NULL, NULL, '2017-12-21 23:44:13', 0);
INSERT INTO `user` VALUES (5, 'qq', 'root', NULL, 'qq@163.com', NULL, 0, NULL, NULL, '2017-12-21 23:45:09', 0);
