...
<head>
    ...
    <link rel="stylesheet" href="<c:url value='/AmazeUI-2.4.2/assets/css/amazeui.min.css'/>"/>
...
<div class="login-boxtitle">
    <a href="home/demo.html"><img alt="" src="<c:url value='/images/logobig.png'/>"/></a>
</div>
            ...
            <div class="am-tabs" id="doc-my-tabs">
                ...
                <div class="am-tabs-bd">
                    <div class="am-tab-panel am-active">
                        <form method="post" id="form_regist" action="<c:url value='/userServlet'/>">
                            ...
                            <div class="user-pass">
                                ...
                                </label> <input type="password" name="passwordRepeat" id="passwordRepeat" name="passwordRepeat"
                                                placeholder="确认密码">
                            </div>
                        ...
                        <div class="am-cf">
                            <input type="button" value="注册" onclick="javascript:form_regist.submit();"
