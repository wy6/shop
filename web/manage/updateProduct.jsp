    ...
    <form class="layui-form" action="/manageProductServlet" method="post">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="productName" id="productName" autocomplete="off" placeholder="请输入商品名称"
                       class="layui-input" style='width:490px' value="${item.name}">
            </div>
        </div>
        <div class="layui-form-item">
        <label class="layui-form-label">商品图片</label>
        <div class="layui-input-inline">
            <input type="hidden" id="filepath" name="photo"/>
            <image name="photo" id="productImg" src="<c:url value='/${item.photo}'/>"  style='width:150px;height: 150px'/>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="price" id="price" placeholder="请输入商品价格"
                       autocomplete="off" class="layui-input" value="${item.price}" style='width:190px'>
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="markPrice" id="markPrice" placeholder="请输入商品市场价格"
                       autocomplete="off" class="layui-input" value="${item.markprice}" style='width:190px'>
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="quality" id="quality" placeholder="请输入商品数量"
                       autocomplete="off" class="layui-input" value="${item.quality}" style='width:190px'>
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="hit" id="hit" placeholder="请输入商品浏览量"
                       autocomplete="off" class="layui-input" value="${item.hit}" style='width:190px'>
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="publishDate" id="publishDate" lay-verify="date" placeholder="请选择发布日期"
                       autocomplete="off" class="layui-input" onclick="layui.laydate({elem: this})" value="${item.time}" style='width:190px'>
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="introduction" id="introduction" placeholder="请输入商品简介"
                       autocomplete="off" class="layui-input" value="${item.introduction}" style='width: 490px'>
            </div>
        </div>
        <div class="layui-form-item layui-form-text">
            <label class="layui-form-label">商品详情</label>
            <div class="layui-input-inline" style='width: 666px'>
                <textarea id="content" name="content" style="width:700px;height:250px;">${item.content}</textarea>
                <script type="text/javascript">
        ...
        <div class="layui-form-item">
            <div class="layui-input-block">
                <button class="layui-btn" onclick="return check();">确认修改</button>
