...
<link rel="stylesheet" href="<c:url value='plugins/layui/css/layui.css'/>" media="all" />
<link rel="stylesheet" href="<c:url value='css/global.css'/>" media="all">
...
<body>
	<div class="layui-layout layui-layout-admin">
			...
			<div class="layui-main">
				<div class="admin-login-box">
					<a class="logo" style="left: 0;" href="#"> <span
						style="font-size: 22px;">网上商城后台管理</span>
					</a>
				...
				<ul class="layui-nav admin-header-item">
					...
					<li class="layui-nav-item"><a href="javascript:;"
						class="admin-header-user"> <img src="<c:url value='images/1.png'/>" /> <span>${user.username}</span>
					</a>
						<dl class="layui-nav-child">
							...
							<dd>
								<a href="javascript:loginout();"><i class="fa fa-sign-out"
									aria-hidden="true"></i> 注销</a>
							</dd>
						</dl></li>
				</ul>
				<ul class="layui-nav admin-header-item-mobile">
					<li class="layui-nav-item"><a href="javascript:loginout();"><i
		...
		<div class="layui-footer footer footer-demo" id="admin-footer">
			<div class="layui-main">
				<p>
					2017 &copy; <a href="#">信息技术系 技术支持</a> Veny license
				</p>
			</div>
		</div>
		...
		<script type="text/javascript" src="<c:url value='plugins/layui/layui.js'/>"></script>
		<script type="text/javascript" src="<c:url value='datas/nav.js'/>"></script>
