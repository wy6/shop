...
<div class="center">
                                    ...
                                    <c:forEach items="${orderlist}" var="orderitem">
                                        <div class="order-status5">
                                            <div class="order-title">
                                                <span>订单编号：<a href="javascript:;">${orderitem.orderid}</a>
                                                </span>&nbsp;&nbsp;&nbsp;&nbsp;
                                                <span>订单提交时间：
                                                    <fmt:formatDate type="time" value="${orderitem.ordertime }"
                                                    ...
                                                    <div class="move-right">
                                                        <li class="td td-status">
                                                            <div class="item-status">
                                                                ...
                                                                <p class="order-info">
                                                                    <a href="<c:url value='/orderServlet?action=findById&id=${orderitem.orderid}' />">订单详情</a>
                                                                </p>
                                                                <p class="order-info">
                                                        ...
                                                        <li class="td td-change">
                                                            <c:choose>
                                                                ...
                                                                <c:when test="${orderitem.status==1}">
                                                                    <div class="am-btn am-btn-danger anniu">取消订单</div>
                                                                </c:when>
                                                                <c:when test="${orderitem.status==2}">
                                                        ...
                                                        <div class="item-info">
                                                            <div class="item-basic-info">
                                                                <a href="#">
                                                                    ...
                                                                    <p class="info-little">颜色：12#川南玛瑙<br/>包装：裸装
                                                                    </p>
                                                                </a>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="item-info">
                                                            <div class="item-basic-info">
                                                                <a href="#">
                                                                    ...
                                                                    <p class="info-little">颜色分类：李清照<br/>尺码：均码</p>
                                                                </a>
                                                            </div>
                                                        </div>
                                                    </li>
    ...
    <aside class="menu">
        <ul>
            <li class="person active"><a href="index.html">
