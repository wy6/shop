...
<head>
    ...
    <link href="<c:url value='/css/personal.css'/>" rel="stylesheet" type="text/css">
    <link href="<c:url value='/css/orstyle.css'/> " rel="stylesheet" type="text/css">
                ...
                <ul class="message-r">
                    ...
                    <div class="topMessage my-shangcheng">
                        <div class="menu-hd MyShangcheng">
                            <a href="<c:url value='/person/index.jsp'/>" target="_top">
                    ...
                    <div class="topMessage mini-cart">
                        <div class="menu-hd">
                            <a id="mc-menu-hd" href="<c:url value='/home/cart.jsp'/>" target="_top">
                    ...
                    <div class="order-main">
                        ...
                        <div class="order-status3">
                            <div class="order-title">
                                <span>订单编号：<a href="javascript:;">${order.orderid}</a></span>&nbsp;&nbsp;&nbsp;&nbsp;
                                <span>成交时间：
                                            ...
                                            <li class="td td-item">
                                                <div class="item-pic">
                                                    <a href="<c:url value='/productServlet?action=findbyid&id=${item.product.productid}'/>"
                                                       class="J_MakePoint">
                                                        <img src="<c:url value='${item.product.photo}'/> " class="itempic J_ItemImg">
                                                    </a>
                                                </div>
                                                <div class="item-info">
